...
final case class FirstPersonSingularPossessivePronoun(word: String) extends SingularPossessivePronoun {
  override def properties: List[Property] = List(Property(x => speaker(x)))

  override def definiteProperties: List[Property] = properties
}

final case class SecondPersonSingularPossessivePronoun(word: String) extends SingularPossessivePronoun {
  override def properties: List[Property] = List(Property(x => interlocutor(x)))

  override def definiteProperties: List[Property] = properties
}

final case class ThirdPersonSingularPossessivePronoun(word: String, gender: PronounGender)
...
final case class FirstPersonPluralPossessivePronoun(word: String) extends SingularPossessivePronoun {
  override def properties: List[Property] = List(Property(x => speaker(x)))

  override def definiteProperties: List[Property] = properties
}

final case class SecondPersonPluralPossessivePronoun(word: String) extends SingularPossessivePronoun {
  override def properties: List[Property] = List(Property(x => interlocutor(x)))

  override def definiteProperties: List[Property] = properties
}

final case class ThirdPersonPluralPossessivePronoun(word: String) extends SingularPossessivePronoun {
  override def properties: List[Property] = List()
